...
```bash
git clone https://github.com/webjsmaster/NodeJS_Task-5_rsschool-nodejs-task-graphql.git
git checkout dev
...
You can find Postman collection in the `./GraphQL.postman_collection.json` file to simplify testing the application.
